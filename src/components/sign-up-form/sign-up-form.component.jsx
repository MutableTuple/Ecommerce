    ...
    return(
        ...
        <h2>Don't have an account?</h2>
            ...
            <form action="" onSubmit={ handleSubmit }>
                ...
                <FormInput label="Display Name" type="text" required name="" id="" onChange={handleChange} name = "displayName" value = { displayName } />
                ...
                <FormInput label="Confirm Password" type="password" required name="" id="" onChange={handleChange} name = "confirmPassword" value = { confirmPassword } />
